...
export const translations: Record<Language, any> = {
  ...
  en: {
    ...
    settings: {
      ...
      logout: 'Logout', followUs: 'Follow us @socialproapp', poweredBy: 'Powered by SMY Agency, Munich', preferences: 'Preferences',
  ...
  tr: {
    ...
    settings: {
      ...
      logout: 'Çıkış yap', followUs: 'Bizi takip edin @socialproapp', poweredBy: 'SMY Agency, Münih tarafından geliştirildi', preferences: 'Tercihler',
