...
export const translations: Record<Language, any> = {
  de: {
    ...
    settings: {
      ...
      reportProblemSubject: 'SocialPro - Fehlerbericht',
      reportProblemBody: 'Hallo SMY Team, ich habe folgendes Problem gefunden:',
      featureRequest: 'Feature vorschlagen',
      featureRequestSubject: 'SocialPro - Feature-Wunsch',
      featureRequestBody: 'Hallo SMY Team, ich wuensche mir folgendes Feature:',
      followUs: 'Folge uns @socialproapp',
      poweredBy: 'Entwickelt von SMY Agency, München', preferences: 'Einstellungen',
  ...
  en: {
    ...
    settings: {
      ...
      logout: 'Logout', feedback: 'Feedback',
      reportProblem: 'Report a Problem',
      reportProblemSubject: 'SocialPro - Bug Report',
      reportProblemBody: 'Hi SMY Team, I found an issue:',
      featureRequest: 'Request a Feature',
      featureRequestSubject: 'SocialPro - Feature Request',
      featureRequestBody: 'Hi SMY Team, I would love to see:',
      followUs: 'Follow us @socialproapp', poweredBy: 'Powered by SMY Agency, Munich', preferences: 'Preferences',
  ...
  es: {
    ...
    settings: {
      ...
      reportProblemSubject: 'SocialPro - Reporte de error',
      reportProblemBody: 'Hola equipo SMY, encontre un problema:',
      featureRequest: 'Sugerir una funcion',
      featureRequestSubject: 'SocialPro - Solicitud de funcion',
      featureRequestBody: 'Hola equipo SMY, me gustaria ver:',
      followUs: 'Síguenos @socialproapp',
      poweredBy: 'Desarrollado por SMY Agency, Múnich', preferences: 'Preferencias',
  ...
  tr: {
    ...
    settings: {
      ...
      logout: 'Çıkış yap', feedback: 'Geri Bildirim',
      reportProblem: 'Sorun bildir',
      reportProblemSubject: 'SocialPro - Hata Raporu',
      reportProblemBody: 'Merhaba SMY Ekibi, bir sorun buldum:',
      featureRequest: 'Ozellik iste',
      featureRequestSubject: 'SocialPro - Ozellik Istegi',
      featureRequestBody: 'Merhaba SMY Ekibi, su ozelligi gormek isterim:',
      followUs: 'Bizi takip edin @socialproapp', poweredBy: 'SMY Agency, Münih tarafından geliştirildi', preferences: 'Tercihler',
